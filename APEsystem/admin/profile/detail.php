...
$sql = "SELECT user_fname, user_lname, user_name, user_position, user_address, user_gender, user_birth, user_birth, user_bdegree, user_gdegree, user_school, user_seminar, user_thumbnail, user_image
        FROM tbl_user
...
<form action="processUser.php?action=modify" method="post" enctype="multipart/form-data" name="frmAddUser" id="frmAddUser">
 <table border="0" cellpadding="5" cellspacing="1" class="entryTable">
   <tr>
	<td colspan="2"><a href='<?php echo WEB_ROOT;?>profileImages/<?php echo $user_image;?>'><img src="<?php echo WEB_ROOT;?>profileImages/<?php echo $user_thumbnail;?>">   </a>
