...
$total = $A1 + $A2 + $A3 + $A4 + $A5 + $A6 + $A7 + $A8 + $B1 + $B2 + $B3 + $B4 + $B5 + $B6 + $B7 + $C1 + $C2 + $D1 + $D2 + $D3 + $D4;
			
		$sql   = "UPDATE tbl_deanseval SET d_teacher='$teacher', d_dateEval='$dateEval', d_timeEval='$timeEval', d_classSize='$classSize', d_courseNum='$courseNum', d_courseDesc='$courseDesc', d_A1='$A1', d_A2='$A2', d_A3='$A3', d_A4='$A4', d_A5='$A5', d_A6='$A6', d_A7='$A7', d_A8='$A8', d_B1='$B1', d_B2='$B2', d_B3='$B3', d_B4='$B4', d_B5='$B5', d_B6='$B6', d_B7='$B7', d_C1='$C1', d_C2='$C2', d_D1='$D1', d_D2='$D2', d_D3='$D3', d_D4='$D4', d_total='$total' WHERE d_teacher='$teacher'";
...
$total = $A1 + $A2 + $A3 + $A4 + $A5 + $A6 + $A7 + $A8 + $B1 + $B2 + $B3 + $B4 + $B5 + $B6 + $B7 + $C1 + $C2 + $D1 + $D2 + $D3 + $D4;
		...
		$sql   = "INSERT INTO tbl_deanseval (d_teacher, d_dateEval, d_timeEval, d_classSize, d_courseNum, d_courseDesc, d_A1, d_A2, d_A3, d_A4, d_A5, d_A6, d_A7, d_A8, d_B1, d_B2, d_B3, d_B4, d_B5, d_B6, d_B7, d_C1, d_C2, d_D1, d_D2, d_D3, d_D4, d_total)
		          VALUES ('$teacher', '$dateEval', '$timeEval', '$classSize', '$courseNum', '$courseDesc', '$A1', '$A2', '$A3', '$A4', '$A5', '$A6', '$A7', '$A8', '$B1', '$B2', '$B3', '$B4', '$B5', '$B6', '$B7', '$C1', '$C2', '$D1', '$D2', '$D3', '$D4', '$total')";
