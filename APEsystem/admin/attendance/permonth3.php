...
<form action="process.php?action=addSem" method="post" enctype="multipart/form-data" name="frmAdd">
 ...
 <!--<th align="left"><img src="<?php echo WEB_ROOT;?>calmonth/<?php echo $m;?>.png">-->
   ...
   <th align="left" width="50%"><input type="button" value="View Detail" onclick="window.location.href='index.php?view=permonthdetail&status=present&user=<?php echo $username; ?>&month=<?php echo $datemonth;?>';"></td>
  </tr>   
  <tr> 
   <th align="left"  >&nbsp;</td>
   <th align="left" >Late :<?php echo $late;?></td>
   <th align="left" width="50%"><input type="button" value="View Detail" onclick="window.location.href='index.php?view=permonthdetail&status=late&user=<?php echo $username; ?>&month=<?php echo $datemonth;?>';"></td>
  </tr>
    <tr> 
   <th align="left"  >&nbsp;</td>
   <th align="left" >Absent :<?php echo $absent;?></td>
   <th align="left" width="50%"><input type="button" value="View Detail" onclick="window.location.href='index.php?view=permonthdetail&status=absent&user=<?php echo $username; ?>&month=<?php echo $datemonth;?>';"></td>
  </tr>
     <tr> 
   <th align="left" >&nbsp;</td>
   <th align="left">Sick :<?php echo $sick;?></td>
   <th align="left" width="50%"><input type="button" value="View Detail" onclick="window.location.href='index.php?view=permonthdetail&status=sick&user=<?php echo $username; ?>&month=<?php echo $datemonth;?>';"></td>
  </tr>
     <tr> 
   <th align="left"  >&nbsp;</td>
   <th align="left">Emergency :<?php echo $emergency;?></td>
   <th align="left" width="50%"><input type="button" value="View Detail" onclick="window.location.href='index.php?view=permonthdetail&status=emergency&user=<?php echo $username; ?>&month=<?php echo $datemonth;?>';"></td>
  </tr>
     <tr> 
   <th align="left" >&nbsp;</td>
   <th align="left"  >Vacation :<?php echo $vacation;?></td>
   <th align="left" width="50%"><input type="button" value="View Detail" onclick="window.location.href='index.php?view=permonthdetail&status=vacation&user=<?php echo $username; ?>&month=<?php echo $datemonth;?>';"></td>
  </tr>
