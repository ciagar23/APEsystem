...
<form action="process.php?action=modifySem" method="post" enctype="multipart/form-data" name="frmAdd">

 <table border="0" cellpadding="5" cellspacing="1" class="entryTable" align="center">
  <tr> 
   <th align="left" colspan="2" >Modify <?php echo $tfname; ?> <?php echo $tlname; ?>'s Attendance at <?php echo $sem_name; ?>:</td>
